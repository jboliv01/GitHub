...
public class Address
{
    ...
    internal int CompareTo(Address that)
    {

        if (this.Name.CompareTo(that.Name) != 0)
            return this.Name.CompareTo(that.Name);
        else if (this.Address1.CompareTo(that.Address1) != 0)
            return this.Address1.CompareTo(that.Address1);
        else if (this.Address2.CompareTo(that.Address2) != 0)
            return this.Address2.CompareTo(that.Address2);
        else if (this.City.CompareTo(that.City) != 0)
            return this.City.CompareTo(that.City);
        else if (this.State.CompareTo(that.State) != 0)
            return this.State.CompareTo(that.State);
        else
            return this.Zip.CompareTo(that.Zip);
